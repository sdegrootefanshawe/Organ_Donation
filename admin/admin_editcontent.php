    ...
    <section class="grey-container map">
        ...
        <div class="row expanded collapse">
            <div class="small-6 float-left column">
                ...
                <h3 class="small-12 column">over <span> <form action="admin_editcontent.php" method="post">
         <br><input type="text" name="section1" value="<?php echo $populateContent['content_section_one']; ?>">
         </span><br> ontarians are<br> waiting to receive<br> <span>life saving</span><br> organ transplants</h3>
