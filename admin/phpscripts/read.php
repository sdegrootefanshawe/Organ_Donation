<?php
	...
	function getInfo(){
		...
		$queryInfo = "SELECT * FROM tbl_content ORDER BY content_id DESC LIMIT 1";
		$runInfo = mysqli_query($link, $queryInfo);
		
		if($runInfo){
			$found_info = mysqli_fetch_array($runInfo, MYSQLI_ASSOC);
			return $found_info;
		}else{
